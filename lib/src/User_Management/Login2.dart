...
import '../Costum_views/RFFlutterToast.dart';

class Login2 extends StatelessWidget{
  Login2({Key ? key}):super(key: key);

  RFtextField inputEmail=new RFtextField(Label_text:"Email");
  RFtextField inputPassword=new RFtextField(Label_text: "Password",);
